  ...
  <div class="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-dark-900">
    <div class="w-full max-w-md space-y-6">
      ...
      <template v-else>
        ...
        <!-- Order Info -->
        <div v-if="order" class="rounded-xl bg-white p-5 shadow-xs dark:bg-dark-800">
        ...
        <div v-else-if="returnInfo" class="rounded-xl bg-white p-5 shadow-xs dark:bg-dark-800">
          <div class="space-y-3 text-sm">
