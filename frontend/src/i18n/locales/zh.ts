export default {
  ...
  modelPlaza: {
    title: '模型广场',
    description: '查看分组、倍率和模型基础价格',
    failedToLoad: '模型广场加载失败',
    summaryPlatforms: '平台数',
    summaryGroups: '分组',
    summaryModels: '模型数',
    platformsTitle: '平台概览',
    platformsHint: '点击平台卡片即可筛选对应分组',
    allPlatforms: '全部平台',
    groupsTitle: '分组',
    groupsHint: '当前共 {count} 个分组',
    filteredGroupsHint: '{platform} 下共 {count} 个分组',
    groupUnit: '组',
    platformCardModels: '{count} 个模型',
    rateLabel: '倍率',
    modelsLabel: '模型数',
    rateShort: '倍率 {rate}',
    groupModelCount: '本组共 {count} 个模型',
    inputPrice: '输入',
    outputPrice: '输出',
    cacheWritePrice: '缓存写入',
    cacheReadPrice: '缓存读取',
    billingModeToken: 'Token',
    billingModeRequest: '按次',
    billingModeImage: '图片',
    noModelsTitle: '暂无可展示模型',
    noModelsDescription: '当前分组已公开，但暂时没有可展示的具体模型。',
    emptyTitle: '该平台下暂无分组',
  ...
  redeem: {
    ...
    newConcurrency: '新并发数',
    aboutCodes: '关于兑换码',
    codeRule1: '大多数兑换码只能使用一次，福利兑换码可被多人领取直到次数耗尽',
    codeRule2: '兑换码可以增加余额、并发数、订阅权益，或发放福利金额',
    codeRule3: '如有兑换问题，请联系客服',
    codeRule4: '余额和并发数即时更新',
    recentActivity: '最近活动',
    historyWillAppear: '您的兑换历史将显示在这里',
    balanceAddedRedeem: '余额充值（兑换）',
    welfareAddedRedeem: '福利领取',
  ...
  admin: {
    ...
    redeem: {
      ...
      codeType: '类型',
      customCode: '自定义兑换码',
      customCodePlaceholder: '留空自动生成',
      customCodeHint: '留空按原逻辑随机生成；填写后仅创建这一条兑换码',
      countLockedByCustomCode: '已填写自定义兑换码，数量固定为 1',
      amount: '金额 ($)',
      amountPerClaim: '单次金额 ($)',
      value: '面值',
      count: '数量',
      countHint: '要生成的兑换码数量',
      claimCount: '可领取次数',
      claimCountHint: '该福利码最多可被多少个不同用户领取',
      perClaim: '次',
      totalAmount: '累计金额',
      welfareCodePlaceholder: '福利码必须填写自定义兑换码',
      welfareCodeRequired: '福利兑换码必须填写自定义兑换码',
      welfareCodeRequiredHint: '福利码必须使用自定义兑换码，且可供多人领取。',
      welfareTotalPreview: '福利总额：${total}',
      viewClaims: '领取记录',
      claimsTitle: '领取记录',
      claimUser: '用户',
      claimAmount: '金额',
