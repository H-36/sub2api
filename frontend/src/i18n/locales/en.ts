export default {
  ...
  modelPlaza: {
    title: 'Model Plaza',
    description: 'Browse public groups, multipliers, and model base prices',
    failedToLoad: 'Failed to load model plaza',
    summaryPlatforms: 'Platforms',
    summaryGroups: 'Public Groups',
    summaryModels: 'Models',
    platformsTitle: 'Platform Overview',
    platformsHint: 'Click a platform card to filter its groups',
    allPlatforms: 'All Platforms',
    groupsTitle: 'Public Groups',
    groupsHint: '{count} public groups available',
    filteredGroupsHint: '{platform}: {count} public groups',
    groupUnit: 'groups',
    platformCardModels: '{count} models',
    rateLabel: 'Rate',
    modelsLabel: 'Models',
    rateShort: 'Rate {rate}',
    groupModelCount: '{count} models in this group',
    inputPrice: 'Input',
    outputPrice: 'Output',
    ...
    noModelsDescription: 'This group is public, but no concrete models are exposed right now.',
    emptyTitle: 'No groups under this platform',
  ...
  redeem: {
    ...
    codeRule1: 'Most codes are single-use; welfare codes can be claimed by multiple users until exhausted',
    codeRule2: 'Codes may add balance, increase concurrency, grant subscriptions, or distribute welfare credits',
  ...
  admin: {
    ...
    redeem: {
      ...
      customCodeHint: 'Leave empty to use the existing random generation flow; when set, only one code will be created.',
      countLockedByCustomCode: 'Custom code is set, so count is fixed to 1',
      amount: 'Amount ($)',
      ...
      claimCountHint: 'How many different users can claim this welfare code',
      perClaim: 'claim',
      totalAmount: 'Total',
      welfareCodePlaceholder: 'Required for welfare codes',
      welfareCodeRequired: 'Welfare redeem code requires a custom code',
      welfareCodeRequiredHint: 'Welfare codes must use a custom code and can be claimed by multiple users.',
      welfareTotalPreview: 'Total welfare amount: ${total}',
      viewClaims: 'Claimants',
      claimsTitle: 'Claim Records',
      claimUser: 'User',
      claimAmount: 'Amount',
      claimTime: 'Claimed At',
      loadingClaims: 'Loading claim records...',
      noClaims: 'No one has claimed this code yet',
      generating: 'Generating...',
      generate: 'Generate',
      copyAll: 'Copy All',
      copied: 'Copied!',
