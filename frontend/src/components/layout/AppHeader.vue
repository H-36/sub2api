    ...
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl bg-linear-to-br from-primary-500 to-primary-600 text-sm font-medium text-white shadow-xs">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
