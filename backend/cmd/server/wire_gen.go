...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelPlazaService := service.ProvideModelPlazaService(groupRepository, channelService, accountRepository, billingService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, modelPlazaHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, idempotencyCoordinator, idempotencyCleanupService)
