...
func (r *redeemRejectRepo) HasClaimByUser(ctx context.Context, redeemCodeID, userID int64) (bool, error) {
	panic("unexpected HasClaimByUser call")
}

func (r *redeemRejectRepo) CreateClaim(ctx context.Context, redeemCodeID, userID int64, amount float64) error {
	panic("unexpected CreateClaim call")
}

func (r *redeemRejectRepo) IncrementClaimedCount(ctx context.Context, id, maxClaims int64) (int, error) {
	panic("unexpected IncrementClaimedCount call")
}

func (r *redeemRejectRepo) ListClaimsByRedeemCode(ctx context.Context, redeemCodeID int64) ([]RedeemCodeClaim, error) {
