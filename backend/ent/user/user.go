...
const (
	...
	// EdgeRedeemCodeClaims holds the string denoting the redeem_code_claims edge name in mutations.
	EdgeRedeemCodeClaims = "redeem_code_claims"
	...
	// RedeemCodeClaimsTable is the table that holds the redeem_code_claims relation/edge.
	RedeemCodeClaimsTable = "redeem_code_claims"
	// RedeemCodeClaimsInverseTable is the table name for the RedeemCodeClaim entity.
	// It exists in this package in order to avoid circular dependency with the "redeemcodeclaim" package.
	RedeemCodeClaimsInverseTable = "redeem_code_claims"
	// RedeemCodeClaimsColumn is the table column denoting the redeem_code_claims relation/edge.
	RedeemCodeClaimsColumn = "user_id"
...
// ByRedeemCodeClaimsCount orders the results by redeem_code_claims count.
func ByRedeemCodeClaimsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newRedeemCodeClaimsStep(), opts...)
	}
}

// ByRedeemCodeClaims orders the results by redeem_code_claims terms.
func ByRedeemCodeClaims(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newRedeemCodeClaimsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newRedeemCodeClaimsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(RedeemCodeClaimsInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, RedeemCodeClaimsTable, RedeemCodeClaimsColumn),
	)
}
