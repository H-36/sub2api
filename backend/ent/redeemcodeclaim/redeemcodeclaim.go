...
const (
	// Label holds the string label denoting the redeemcodeclaim type in the database.
	Label = "redeem_code_claim"
	...
	EdgeUser = "user"
	// Table holds the table name of the redeemcodeclaim in the database.
	Table = "redeem_code_claims"
	// RedeemCodeTable is the table that holds the redeem_code relation/edge.
	RedeemCodeTable = "redeem_code_claims"
...
// Columns holds all SQL columns for redeemcodeclaim fields.
var Columns = []string{
	FieldID,
	FieldRedeemCodeID,
	FieldUserID,
...
// OrderOption defines the ordering options for the RedeemCodeClaim queries.
