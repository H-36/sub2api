...
type UserEdges struct {
	...
	// RedeemCodeClaims holds the value of the redeem_code_claims edge.
	RedeemCodeClaims []*RedeemCodeClaim `json:"redeem_code_claims,omitempty"`
...
// RedeemCodeClaimsOrErr returns the RedeemCodeClaims value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) RedeemCodeClaimsOrErr() ([]*RedeemCodeClaim, error) {
	if e.loadedTypes[2] {
		return e.RedeemCodeClaims, nil
	}
	return nil, &NotLoadedError{edge: "redeem_code_claims"}
}
...
// QueryRedeemCodeClaims queries the "redeem_code_claims" edge of the User entity.
func (_m *User) QueryRedeemCodeClaims() *RedeemCodeClaimQuery {
	return NewUserClient(_m.config).QueryRedeemCodeClaims(_m)
}
